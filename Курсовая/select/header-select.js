function selectOpen() {
  ...
  headerElement.forEach(el => {
    el.addEventListener('click', () => {
      if (el.parentElement.parentElement.querySelector('.hiding-list')) {
        const list = el.parentElement.parentElement.querySelector('.hiding-list');
        ...
        if (el.parentElement.parentElement.querySelector('.visible-list')) {
          const list = el.parentElement.parentElement.querySelector('.visible-list');
